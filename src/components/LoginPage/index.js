...
const LoginPage = () =>{
    ...
    return (
        <div className='loginPage'>
            ...
            <input className='input_holder' type='text' placeholder='이메일을 입력해주세요' onChange={(e) => setUserInfo((prevState)=>{return {...prevState, email: e.target.value}})}/>
            <br />
            <br />
            <input className='input_holder' type='password' placeholder='비밀번호를 입력해주세요' onKeyPress={handleEnter} onChange={(e) => setUserInfo((prevState)=>{return {...prevState, password: e.target.value}})}/>
            <br />
            <br />
